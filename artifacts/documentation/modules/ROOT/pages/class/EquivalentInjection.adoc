...
EquivalentInjection -> Terminal: Terminals


EquivalentInjection -> EquipmentContainer: EquipmentContainer


EquivalentInjection -> UseagePoint: UseagePoints


EquivalentInjection -> PSRType: PSRType


EquivalentInjection -> AssetInfo: AssetDataSheet


EquivalentInjection -> Asset: Assets
...
| <<regulationCapability,`regulationCapability`>>
//| [[slots_table.regulationCapability]]<<regulationCapability,`regulationCapability`>>
| 1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++Specifies whether or not the EquivalentInjection has the capability to regulate the local voltage. If true the...+++
| _n/a_
...
[.text-left]
--
<<slots_table.regulationCapability,&#10548;>>
--
////
