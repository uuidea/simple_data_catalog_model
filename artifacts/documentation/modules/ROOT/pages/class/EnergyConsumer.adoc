...
EnergyConsumer -> UseagePoint: UseagePoints


EnergyConsumer -> PSRType: PSRType


EnergyConsumer -> AssetInfo: AssetDataSheet


EnergyConsumer -> Asset: Assets
...
| xref::class/LoadResponseCharacteristic.adoc[`LoadResponseCharacteristic`] | xref::class/LoadResponseCharacteristic.adoc#EnergyConsumer[`EnergyConsumer`]
