...
BusSegment -> BaseVoltage: BaseVoltage


BusSegment -> Terminal: Terminals


BusSegment -> EquipmentContainer: EquipmentContainer


BusSegment -> UseagePoint: UseagePoints


BusSegment -> PSRType: PSRType


BusSegment -> AssetInfo: AssetDataSheet


BusSegment -> Asset: Assets
