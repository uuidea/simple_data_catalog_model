...
EnergySource -> BaseVoltage: BaseVoltage


EnergySource -> Terminal: Terminals


EnergySource -> EquipmentContainer: EquipmentContainer


EnergySource -> UseagePoint: UseagePoints


EnergySource -> PSRType: PSRType


EnergySource -> AssetInfo: AssetDataSheet


EnergySource -> Asset: Assets
...
| 0..1 +
https://w3id.org/linkml/Double[`double`]
| +++This is the maximum active power that can be produced by the source. Load sign convention is used, i.e. positive sign means...+++
| _n/a_
...
| 0..1 +
https://w3id.org/linkml/Double[`double`]
| +++This is the minimum active power that can be produced by the source. Load sign convention is used, i.e. positive sign means...+++
| _n/a_
...
|===
| URI
| http://alliander.com/uno-gridbuilder#EnergySource.UMax[`uno:EnergySource.UMax`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Double[`double`]
...
|===
| URI
| http://alliander.com/uno-gridbuilder#EnergySource.UMin[`uno:EnergySource.UMin`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Double[`double`]
