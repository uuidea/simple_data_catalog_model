...
EarthFaultCompensator -> BaseVoltage: BaseVoltage


EarthFaultCompensator -> Terminal: Terminals


EarthFaultCompensator -> EquipmentContainer: EquipmentContainer


EarthFaultCompensator -> UseagePoint: UseagePoints


EarthFaultCompensator -> PSRType: PSRType


EarthFaultCompensator -> AssetInfo: AssetDataSheet


EarthFaultCompensator -> Asset: Assets
