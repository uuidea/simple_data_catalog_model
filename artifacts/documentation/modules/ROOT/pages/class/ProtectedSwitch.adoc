...
ProtectedSwitch -> UseagePoint: UseagePoints


ProtectedSwitch -> PSRType: PSRType


ProtectedSwitch -> AssetInfo: AssetDataSheet


ProtectedSwitch -> Asset: Assets
...
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++Flag to indicate whether the switch has remote control+++
| xref::class/Switch.adoc[`Switch`]

| <<remoteMonitored,`remoteMonitored`>>
//| [[slots_table.remoteMonitored]]<<remoteMonitored,`remoteMonitored`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++Flag to indicate whether the switch has remote monitoring+++
| xref::class/Switch.adoc[`Switch`]
...
|===
| URI
| http://alliander.com/uno-gridbuilder#Switch.remoteControlled[`uno:Switch.remoteControlled`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
|===
| URI
| http://alliander.com/uno-gridbuilder#Switch.remoteMonitored[`uno:Switch.remoteMonitored`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
