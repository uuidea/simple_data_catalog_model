...
BusbarSection -> BusbarSection: NormalFeedingBusbarSection


BusbarSection -> Feeder: Feeder
...
BusbarSection -> UseagePoint: UseagePoints


BusbarSection -> PSRType: PSRType


BusbarSection -> AssetInfo: AssetDataSheet


BusbarSection -> Asset: Assets
...
| +++the feeder to which this busbar belongs+++
| _n/a_

| <<NormalFeedingBusbarSection,`NormalFeedingBusbarSection`>>
//| [[slots_table.NormalFeedingBusbarSection]]<<NormalFeedingBusbarSection,`NormalFeedingBusbarSection`>>
| 0..1 +
xref::class/BusbarSection.adoc[`BusbarSection`]
| +++The busbar that is upstream based on normal switch states+++
| _n/a_
...
|===
| URI
| http://alliander.com/uno-gridbuilder#BusbarSection.Feeder[`uno:BusbarSection.Feeder`]
| Cardinality
| 0..1
| Type
| xref::class/Feeder.adoc[`Feeder`]
...
|===
| URI
| http://alliander.com/uno-gridbuilder#BusbarSection.NormalFeedingBusbarSection[`uno:BusbarSection.NormalFeedingBusbarSection`]
| Cardinality
| 0..1
| Type
| xref::class/BusbarSection.adoc[`BusbarSection`]
...
[.text-left]
--
<<slots_table.NormalFeedingBusbarSection,&#10548;>>
--
////
...
| xref::class/BusbarSection.adoc[`BusbarSection`] | xref::class/BusbarSection.adoc#NormalFeedingBusbarSection[`NormalFeedingBusbarSection`]
