...
SeriesCompensator -> Terminal: Terminals


SeriesCompensator -> EquipmentContainer: EquipmentContainer


SeriesCompensator -> UseagePoint: UseagePoints


SeriesCompensator -> PSRType: PSRType


SeriesCompensator -> AssetInfo: AssetDataSheet


SeriesCompensator -> Asset: Assets
...
| 1 +
https://w3id.org/linkml/Double[`double`]
| +++rated Current of the series compensator+++
| _n/a_
...
| 1 +
https://w3id.org/linkml/Double[`double`]
| +++rated Boltage of the series compensator.+++
| _n/a_
...
|===
| URI
| http://alliander.com/uno-gridbuilder#SeriesCompensator.ratedCurrent[`uno:SeriesCompensator.ratedCurrent`]
| Cardinality
| 1
| Type
| https://w3id.org/linkml/Double[`double`]
...
|===
| URI
| http://alliander.com/uno-gridbuilder#SeriesCompensator.ratedVoltage[`uno:SeriesCompensator.ratedVoltage`]
| Cardinality
| 1
| Type
| https://w3id.org/linkml/Double[`double`]
