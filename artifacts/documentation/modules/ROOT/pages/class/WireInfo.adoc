...
| <<resistenceReferenceTemp,`resistenceReferenceTemp`>>
//| [[slots_table.resistenceReferenceTemp]]<<resistenceReferenceTemp,`resistenceReferenceTemp`>>
| 0..1 +
https://w3id.org/linkml/Double[`double`]
| _n/a_
| _n/a_
...
|===
| URI
| http://alliander.com/uno-gridbuilder#WireInfo.resistanceReferenceTemp[`uno:WireInfo.resistanceReferenceTemp`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Double[`double`]
...
[.text-left]
--
<<slots_table.resistenceReferenceTemp,&#10548;>>
--
////
