...
//| [[slots_table.simultaneity]]<<simultaneity,`simultaneity`>>
| 0..1 +
https://w3id.org/linkml/Double[`double`]
| +++load factor of typical load to max contracted load+++
| _n/a_
...
|===
| URI
| http://alliander.com/uno-gridbuilder#Feeder.simultaneity[`uno:Feeder.simultaneity`]
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Double[`double`]
...
| xref::class/Bay.adoc[`Bay`] | xref::class/Bay.adoc#Feeder[`Feeder`]



| xref::class/BusbarSection.adoc[`BusbarSection`] | xref::class/BusbarSection.adoc#Feeder[`Feeder`]



| xref::class/ConnectivityNode.adoc[`ConnectivityNode`] | xref::class/ConnectivityNode.adoc#Feeder[`Feeder`]



| xref::class/Line.adoc[`Line`] | xref::class/Line.adoc#Feeder[`Feeder`]
